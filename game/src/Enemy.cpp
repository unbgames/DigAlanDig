...
Enemy::Enemy(GameObject &associated, int enemyType)
    ...
    if (enemyType == 1) {
        EState[State::IDLE_S] = {ASSETS_PATH("/img/enemies/enemy1/idle.png"), 2, 2,
                                 -1};
        EState[State::WALKIN_S] = {ASSETS_PATH("/img/enemies/enemy1/walkin.png"), 2, 4,
                                   0.2};
        EState[State::DIE_S] = {ASSETS_PATH("/img/enemies/enemy1/idle.png"), 2, 2,
                                0.2};
    } else if (enemyType == 2) {
        EState[State::IDLE_S] = {ASSETS_PATH("/img/enemies/enemy2/idle.png"), 2, 2,
                                 -1};
        EState[State::WALKIN_S] = {ASSETS_PATH("/img/enemies/enemy2/walkin.png"), 2, 4,
                                   0.2};
        EState[State::DIE_S] = {ASSETS_PATH("/img/enemies/enemy2/idle.png"), 2, 2,
                                0.2};
    } else if (enemyType == 3) {
        EState[State::IDLE_S] = {ASSETS_PATH("/img/enemies/enemy3/idle.png"), 2, 2,
                                 -1};
        EState[State::WALKIN_S] = {ASSETS_PATH("/img/enemies/enemy3/walkin.png"), 2, 4,
                                   0.2};
        EState[State::DIE_S] = {ASSETS_PATH("/img/enemies/enemy3/idle.png"), 2, 2,
                                0.2};
    } else {
        EState[State::IDLE_S] = {ASSETS_PATH("/img/enemies/enemy1/idle.png"), 2, 2,
                                 -1};
