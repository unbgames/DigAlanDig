...
void TitleState::LoadAssets() {
    ...
    gm->AddComponent(
        new Sprite(*gm, ASSETS_PATH("/img/HUD e menus/menu principal/Tela_menu.png")));
    ...
    gm->AddComponent(new bgCircularX(
        *gm, ASSETS_PATH("/img/HUD e menus/menu principal/Espaco Profundo.png")));
    ...
    gm->AddComponent(new bgCircularX(
        *gm, ASSETS_PATH("/img/HUD e menus/menu principal/nuvem_1.png")));
    ...
    gm->AddComponent(new ParallaxX(*gm, 2));
    gm->AddComponent(new bgCircularX(
        *gm, ASSETS_PATH("/img/HUD e menus/menu principal/nuvem_2.png")));
    ...
    gm->AddComponent(new bgCircularX(
        *gm, ASSETS_PATH("/img/HUD e menus/menu principal/nuvem_3.png")));

    gm = new GameObject(Common::Layer::HUD);
    Sprite* sprite = new Sprite(*gm, ASSETS_PATH("/img/title.png"));
    ...
    gm = new GameObject(Common::Layer::HUD);
    sprite = new Sprite(*gm, ASSETS_PATH("/img/pressSpace.png"));
    ...
    gm = new GameObject(Common::Layer::HUD);
    sprite = new Sprite(*gm, ASSETS_PATH("/img/marmozord_fly.png"), 2, -1);
    ...
    music.Open(ASSETS_PATH("/audio/menu.ogg"));
}
